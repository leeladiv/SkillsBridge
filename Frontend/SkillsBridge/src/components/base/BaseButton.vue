<script setup>
defineProps({
  variant: { type: String, default: 'primary' }, // primary | secondary | ghost | danger | inverse
...
<template>
  <button
    ...
    :class="[
      ...
      variant === 'ghost' && 'bg-transparent text-white hover:bg-slate-500 focus:ring-slate-300',
